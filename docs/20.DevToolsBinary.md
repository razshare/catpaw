...
The reason this program exists is to help your manage your product life cycle by allowing you to publish new tags, export common files to all projects your product depends on and offers a complete tag nuke options for clearing all (local and remote) git tags.
