...
Loops and conditionals can be achieved through handlebars syntax.

For example iterating over an `items` property
...
Inject the `items` property from php
...
![2024-05-08_09-22](https://github.com/tncrazvan/catpaw/assets/6891346/4fad9a56-2265-4fdf-ad15-1d3e01702514)
...
return 
fn (#[Body] array $body) => // The user has submitted the form.
    superstyle(asFileName(__DIR__, '../view.hbs'))
