...
By default, superstyle wil render your content in a document that looks like this
```html
<!DOCTYPE html>
<html lang="en">
<head>
...
Although you can write your own javascript code to customize behavior, superstyle is mean to be used with libraries like [HTMX](https://htmx.org/).
